            ...
            <td width="100%" style="width:100%;">
                <div style="border:solid #00A7C3 1px; padding: 5px;">
                    <div style="margin:5px 0;">
                        <div>
                            <p style="font-size:11pt;font-family:Arial,sans-serif;color:#000; margin:3px;">
                            Dear Customer<br>
                            Thank you for contacting InCubaTravel, we have received your email, we will get back to you as soon as possible.<br>
                                If you need an urgent answer, please do not hesitate to contact us by phone at this number <a href="tel:+5378384667" target="_blank">(+53) 78384667</a><br/>
                                <br/>
                                Best regards<br/>
