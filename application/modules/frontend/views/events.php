...
<head>
    ...
    <title>InCubaTravel - Events</title>
...
<main>
    ...
    <section>
        <div class="container">
            <div class="hr-title"><?= $this->lang->line('pic_events') ?></div>
            <div class="row">
                <div class="col-md-1">
                </div>
                <div class="col-md-10">
                            ...
                            <tr style="background: #fff">
                                <td style="width: 25%">
                                    ...
                                    <img class="img-thumbnail" width="200"
                                         src="<?= base_url('assets/img/events') ?>/<?= $row->Id ?>.jpg"
                                         alt=""/>
                                </td>
                                <td class="middle" style="width: 60%">
                                    <h4><?= $row->Name ?></h4>
                                    <?= $this->lang->line('place') ?>: <span class="pricenumber"><?= $row->Place ?></span><br>
                                    <?= $this->lang->line('from') ?>: <span class="pricenumber"><?= $row->StartDate ?></span>
                                    <?= $this->lang->line('to') ?>: <span class="pricenumber"><?= $row->EndDate ?></span>

                                </td>
                                <td class="text-center" style="position: relative; width: 15%">
                                    <br>
                                    <?= $this->lang->line('days') ?><br>
                                    <div class="pricenumber"><?= $row->Days ?></div>
                                    <a href="<?= base_url('CartEvent') ?>/<?= $row->Id ?>"
