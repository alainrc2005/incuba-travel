...
<head>
    ...
    <title>InCubaTravel - Round trips</title>
...
<main>
    ...
    <section>
        <div class="container">
            <div class="hr-title"><?= $this->lang->line('pic_roundtrips') ?></div>
            <div class="row">
                <div class="col-md-2">
                            ...
                            <tr style="background: #fff">
                                <td style="width: 35%">
                                    ...
                                    <img class="img-thumbnail" width="200"
                                         src="<?= base_url('assets/img/roundtrips') ?>/<?= $row->Id ?>/front.jpg"
                                         alt=""/>
                                </td>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ko.applyBindings(new vmRoundtrips());
    });
</script>
</body>
</html>